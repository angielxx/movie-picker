<template>
  <div class="UserDetail">
    ...
    <div class="header">
      <div class="user-info">
        <div id="profile" class="user-info__img" :style="`background-image: url(${this.$store.state.API_URL}${this.avatar})`">
  ...
  methods: {
    ...
    submitAvatar() {
      ...
      axios({
        ...
        .then((res) => {
          document.querySelector('#profile').style.backgroundImage = `url(${this.$store.state.API_URL}${res.data.avatar})`
